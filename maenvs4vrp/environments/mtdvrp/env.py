...
class Environment(AECEnv):
    ...
    def _update_curr_agent_feasibility(self):
        ...
        distance2j = get_distance(
            loc, self.td_state["coords"]
        ...
        depot_loc = self.td_state["depot_loc"][
            torch.arange(self.td_state["depot_loc"].shape[0]),
            None,
            self.td_state["cur_agent"]["depot_idx"].squeeze(1),
        ]

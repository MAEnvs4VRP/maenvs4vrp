        ...
        for episode in progress:
            ...
            while not td["done"].all():
                ...
                try:
                    ...
                    global_obs = None
                cur_nodes_idx = td["observations"]["agents_cur_nodes_idx"]

                # get action from the policy
                action, agent, logprobs, ent = policy.get_action_and_logs(
    ...
    with torch.no_grad():
        for instance_name in test_env.inst_generator.set_of_instances:
            ...
            while not td["done"].all():
                ...
                action, agent, _, _ = policy.get_action_and_logs(
                    nodes_obs=node_dyn_obs,
                    all_agents_obs=all_agents_obs,
                    cur_nodes_idx=cur_nodes_idx,
                    agents_action_mask=agents_action_mask,
